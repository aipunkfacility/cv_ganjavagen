...
### 3. Поиск решений (Context7)

- [ ] Если ошибка неочевидна, используйте `mcp_context7` для поиска по документации или GitHub issues (например, `query: "Astro error [CODE]: [MESSAGE]"`).
- [ ] Проверьте совместимость версий пакетов через `context7`.
